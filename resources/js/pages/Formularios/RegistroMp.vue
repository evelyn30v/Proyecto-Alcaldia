...
<div class="contenedordeformularios">
    ...
    <!-- <link rel="stylesheet" type="text/css" href="../../css/cssFormularios.scss"> -->
     <div class="tituloInicial">
        <h1>Registro de medidas preventivas</h1>
    </div>
      ...
      <div class="danger" name="danger">
        <p style="color:#ffff">
          ...
          <strong>¡oh, oh! No se pudo guardar su Medida preventiva</strong> 
        </p>
        <span
          class="closebtn"
          @click="estadoFalse()"
    ...
    <span v-if="msgTrue">
      <div class="mssg" name="msgtrue">
        <p style="color:#ffff">
          ...
          <strong>¡Su Medida preventiva se guardó con exito!</strong>
        </p>
        <span
          class="closebtn"
          @click="estadoFalse()"
    ...
    <form action="mp" @submit.prevent="addDelito()">
        ...
        <div class="formulario">
            ...
            <div class="izquierda">
                <div class="contenedorGeneral">
                    <label class="derecha" for="label_delito">
                        El delito de tipo : </label>
            ...
            <div class="derecha">
                <div class="contenedorGeneral">
                    ...
                    <textarea type="number" class="textarea" cols="30" rows="10" name="observacion" 
                    v-model="newObs" placeholder="Introduzca un texto corto" required></textarea>
                </div>
                 <div class="contenedorGeneral">
                    ...
                    <div class="formulario">
                        ...
                        <p></p>
                        <input type="number" name="anio" class="redondear" placeholder="Año" v-model="newAnio" required>
                    </div>
                </div>
            </div>
    </div>
